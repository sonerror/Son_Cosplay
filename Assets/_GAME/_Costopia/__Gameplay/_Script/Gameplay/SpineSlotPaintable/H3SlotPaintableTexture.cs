  ...
  public class H3SlotPaintableTexture : MonoBehaviour
  {
    ...
    private void ApplySlotReveal()
    {
      ...
      if (slot.Attachment == null)
      {
        ...
        if (slot.Attachment == null)
        {
          // H3Log.LogWarning($"Slot '{slotName}' has no attachment assigned.");
          return;
        }
      }
    ...
    private void GetReferences()
    {
      ...
      if (skeletonAnimation == null)
        // H3Log.LogError("SkeletonAnimation not found.");
    ...
    private void DrawRegionAttachmentGizmo(RegionAttachment regionAttachment, Bone slot)
    {
