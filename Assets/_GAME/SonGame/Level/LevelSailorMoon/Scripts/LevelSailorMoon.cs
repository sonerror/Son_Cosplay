...
public class LevelSailorMoon : GamePlayManager
{
  ...
  [Sirenix.OdinInspector.Button]
   public void TurnOffSlotMouth()
    ...
    {
        itemShowerDrag.AddUseInStep(CurrentStep);
    ...
    private void OnStartStep4()
    {
        ...
        itemBoxCleanser.AddUseInStep(CurrentStep);
    ...
    {
        itemWashMachineDrag.AddUseInStep(CurrentStep);
    ...
    {
        faceTowelDrag.AddUseInStep(CurrentStep);
